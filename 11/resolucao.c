...
long int greatest_product(int matriz[20][20], int adjacent)
{
    ...
    int directions[4][2] = {
        ...
        { -1, 1}, // diagonal positiva (de baixo pra cima ↑)
    };
    int i, j, max_i, max_j;
    long int great = 0, product = 1;
    ...
    for (int d = 0; d < 4; d++)
    {
        ...
        for (; i < max_i; i++)
        {
            ...
            {
                product = 1;
                for (int a = 0; a < adjacent; a++) product = product * matriz[i + a * directions[d][0]][j + a * directions[d][1]];
                if (product > great) great = product;
            }
        }
    }
    return great;
